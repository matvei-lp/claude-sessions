...
- [Require explicit approval](require-explicit-approval.md) — no git ops or file edits without his direct consent; show diffs first
- [PR flow (radiacode-kmp)](pr-flow-radiacode-kmp.md) — auto-add vxrossa reviewer; gh/GitHub, RMP-, base develop, no Co-Authored-By
- [KMP BLE/device-core decisions](kmp-shared-vm-stack.md) — port plan (minimal prod-first PRs) + tech (Kable, KMP-OVM not SKIE) + persistence track; BLE prototype stashed ("BLE prototype — rolled back…"), pull incrementally
